...
try:
    face = cv2.CascadeClassifier('/usr/share/opencv/haarcascades/haarcascade_frontalface_alt.xml')
        #'haar_cascade_files\haarcascade_frontalface_alt.xml')
    leye = cv2.CascadeClassifier('/usr/share/opencv/haarcascades/haarcascade_lefteye_2splits.xml')
        #'haar_cascade_files\haarcascade_lefteye_2splits.xml')
    reye = cv2.CascadeClassifier('/usr/share/opencv/haarcascades/haarcascade_righteye_2splits.xml')
        #'haar_cascade_files\haarcascade_righteye_2splits.xml')
except Exception as err:
    print("Error occured while loadding haar cascades. err: {}".format(err))
